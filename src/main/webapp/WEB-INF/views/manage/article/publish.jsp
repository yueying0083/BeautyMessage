                ...
                <div class="ibox-content">
                    <form action="#" onsubmit="return false;" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="title" type="text" placeholder="请输入标题" class="form-control" onblur="validate(this, 5, 33)">
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input id="sourceName" type="text" placeholder="网站" class="form-control"
                                               onblur="validate(this, -1, 6)">
                                    </div>
                                    <div class="col-md-4">
                                        <input id="sourceUrl" type="text" placeholder="网址" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="tags" type="text" placeholder="以逗号隔开" class="form-control" size="20">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
...
<script>
    window.rootPath = ${root_dir }.toString();
