            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span>
                            <c:if  test="${not empty manager.headImg}">
                                <img alt="image" class="img-circle" src="manager.headImg" />
                            </c:if>
                            <c:if test="${empty manager.headImg}">
                ...
                <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search">
                        <div class="form-group">
                            <input type="text" placeholder="请输入您需要查找的内容 …" class="form-control" name="text" id="top-search">
                        </div>
                    </form>
                </div>
